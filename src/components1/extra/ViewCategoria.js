...
import {
  getCurrentCategoria,deleteCurrentCategoria,updateCurrentCategoria,buscarCurrentCategoria
  
} from "../../actions/categoriaActions.js";
...
class ViewCategoria extends Component {
  constructor(){
    super();
    this.state={
      tipoData:[],
  ...
  toggleModal = (id) => {
    this.props.buscarCurrentCategoria(id);
    this.setState({
   ...
   this.props.updateCurrentCategoria(this.props.buscafile._id,tipoData);
   this.toggleModalfin();
...
ViewCategoria.propTypes = {
  ...
  buscarCurrentCategoria: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getCurrentCategoria ,deleteCurrentCategoria,updateCurrentCategoria,buscarCurrentCategoria })(
  ViewCategoria
);
