                  ...
                  dashboardContent = (          
                          currentTodos.map(l1 => (
                              <tr  key={l1._id}>            
                                    ...
                                    <td>                                       
                                       <button type="button"  onClick={this.toggleModal.bind(this,l1._id,l1.codigo,l1.descripcion)} className="btn btn-primary  mt-4 01579b light-blue darken-2"  >Editar</button>                                         
                                    </td>
                                    <td>    
