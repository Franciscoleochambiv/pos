...
import {
  getCurrentCategoriasql,deleteCurrentCategoriasql,updateCurrentCategoriasql  
...
class ViewVenta extends Component {
  ...
  toggleModal = (id,cod,des) => {
   ...
   onSubmit(e) {
    ...
    this.props.updateCurrentCategoriasql(this.state.codigo,tipoData);
    this.toggleModalfin();
  ...
  onDeleteClick(id) {
    this.props.deleteCurrentCategoriasql(id);
    }

 

  componentDidMount() {
     this.props.getCurrentCategoriasql();
    }
...
export default connect(mapStateToProps, { getCurrentCategoriasql ,deleteCurrentCategoriasql,updateCurrentCategoriasql })(
  ViewCate
);
