...
import { addLineasql } from '../../actions/lineaActions'

import { useForm } from 'react-hook-form'
import ViewLinea from './ViewLinea';
...
const Linea = () => {
  const classes = useStyles();
     ...
     const tip = useSelector (store => store.lineafile.lineafiles)     
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={6}>
          <Card>
            ...
            <CardFooter>
              <Button color="danger" type="submit" >Grabar</Button>
            </CardFooter>
           </form> 
          </Card>
