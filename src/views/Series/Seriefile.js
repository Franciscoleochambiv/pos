...
import { addSeriesql } from '../../actions/serieActions'

import { useForm } from 'react-hook-form'
import ViewSerie from './ViewSerie';
...
const Serie = () => {
  const classes = useStyles();
     ...
     const tip = useSelector (store => store.seriefile.seriefiles)     
        ...
        <GridItem xs={12} sm={12} md={6}>
          <Card>
            <CardHeader color="success">
              <h4 className={classes.cardTitleWhite}>Series</h4>
