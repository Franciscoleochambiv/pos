...
import { addTiposql } from '../../actions/tipoActions'

import { useForm } from 'react-hook-form'
import ViewTipo from './ViewTipo';
        ...
        <GridItem xs={12} sm={12} md={6}>
          <Card>
            <CardHeader color="warning">
              <h4 className={classes.cardTitleWhite}>Tipos Documento</h4>
            ...
            <CardFooter>
              <Button color="warning" type="submit" >Grabar</Button>
            </CardFooter>
           </form> 
          </Card>
